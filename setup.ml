(* OASIS_START *)
(* DO NOT EDIT (digest: a66a342ece2a6555d0b85cd81c47f2d9) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/ppx_inline_test";
          synopsis =
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Inline_test_config"];
                      lib_pack = false;
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "inline_test_config"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Library
                 ({
                     cs_name = "ppx_inline_test_libname";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Ppx_inline_test_libname"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("ppx_driver", None);
                           InternalLibrary "ppx_inline_test_libname";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "drop";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "ppx_inline_test"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      lib_modules = ["Ppx_inline_test_drop"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "ppx_inline_test";
                           FindlibPackage ("ppx_driver", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                   ...
                   {exec_custom = false; exec_main_is = "ppx.ml"});
               Object
                 ({
                     cs_name = "ppx_inline_test_runner";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "ppx_inline_test_lib"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      obj_modules = ["Ppx_inline_test_runner"];
                      obj_findlib_fullname = None
                   })
            ];
          plugins =
            [
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\004\230\012\245<\254\247\231=Q\023\216\202\148\230\016";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
